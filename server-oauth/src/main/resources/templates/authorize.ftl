<html>
<head>
    <link rel="stylesheet" type="text/css" href="/uaa/webjars/bootstrap/css/bootstrap.min.css"/>
    <script type="text/javascript" src="/uaa/webjars/jquery/jquery.min.js"></script>
    <script type="text/javascript" src="/uaa/webjars/bootstrap/js/bootstrap.min.js"></script>
</head>
<body>
<div class="container">
